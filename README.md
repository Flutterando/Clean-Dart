...
É muito comum os desenvolvedores criarem primeiro as suas Views para  "testar" as Regras de Negócio. Mas nós já temos uma ferramenta própria para isso e um lugar dedicado para armazenar esses testes.
